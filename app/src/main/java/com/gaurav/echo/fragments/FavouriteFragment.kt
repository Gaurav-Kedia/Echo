...
import com.gaurav.echo.adapters.FavouriteContentAdapter
import com.gaurav.echo.databases.EchoDatabase
import com.gaurav.echo.fragments.FavouriteFragment.Statified.meediaPlayer
...
class FavouriteFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        noFavourites = view?.findViewById(R.id.nofavorites) as TextView
